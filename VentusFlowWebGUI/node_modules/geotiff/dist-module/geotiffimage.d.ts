...
export type TypedArray = import("../src/geotiff.js").TypedArray;
export type ReadRasterResult = import("../src/geotiff.js").ReadRasterResult;
/**
...
declare class GeoTIFFImage {
     ...
     */
    constructor(fileDirectory: any, geoKeys: any, dataView: DataView, littleEndian: boolean, cache: boolean, source: import('../src/source/basesource.js').BaseSource);
    fileDirectory: any;
    geoKeys: any;
    dataView: DataView;
    ...
    source: import("../src/source/basesource.js").BaseSource;
    /**
     ...
     */
    getTileOrStrip(x: number, y: number, sample: number, poolOrDecoder: import("../src/geotiff.js").Pool | import("../src/geotiff.js").BaseDecoder, signal?: AbortSignal | undefined): Promise<ArrayBuffer>;
    /**
    ...
    readRGB({ window, interleave, pool, width, height, resampleMethod, enableAlpha, signal }?: {
        window?: number[] | undefined;
        interleave?: boolean | undefined;
        pool?: import("../src/pool.js").default | undefined;
        width?: number | undefined;
        height?: number | undefined;
        resampleMethod?: string | undefined;
