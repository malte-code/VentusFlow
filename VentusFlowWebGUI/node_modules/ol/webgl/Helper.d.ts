...
export type BufferCacheEntry = {
     ...
     * Buffer.
     */
    buffer: import("ol/webgl/Buffer").default;
    /**
     * WebGlBuffer.
     */
...
export type UniformLiteralValue = number | Array<number> | HTMLCanvasElement | HTMLImageElement | ImageData | WebGLTexture | import("ol/transform").Transform;
/**
 * Uniform value can be a number, array of numbers (2 to 4), canvas element or a callback returning
 * one of the previous types.
 */
export type UniformValue = UniformLiteralValue | ((arg0: import("ol/Map").FrameState) => UniformLiteralValue);
...
import { UNSIGNED_BYTE } from 'ol/webgl';
import { UNSIGNED_SHORT } from 'ol/webgl';
import { UNSIGNED_INT } from 'ol/webgl';
...
declare class WebGLHelper extends Disposable {
     ...
     */
    deleteBuffer(buf: import("ol/webgl/Buffer").default): void;
    /**
     ...
     */
    prepareDraw(frameState: import("ol/Map").FrameState, disableAlphaBlend?: boolean, enableDepth?: boolean): void;
    /**
     ...
     */
    bindAttribute(buffer: import("ol/webgl/Buffer").default, attributeName: string, size: number): void;
    /**
     ...
     * @param {boolean} [enableDepth] If true, enables depth testing.
     */
    prepareDrawToRenderTarget(frameState: import("ol/Map").FrameState, renderTarget: import("ol/webgl/RenderTarget").default, disableAlphaBlend?: boolean, enableDepth?: boolean): void;
    /**
     ...
     */
    finalizeDraw(frameState: import("ol/Map").FrameState, preCompose?: (arg0: WebGLRenderingContext, arg1: import("ol/Map").FrameState) => void, postCompose?: (arg0: WebGLRenderingContext, arg1: import("ol/Map").FrameState) => void): void;
    /**
     ...
     */
    applyFrameState(frameState: import("ol/Map").FrameState): void;
    /**
     ...
     * @param {import("../Map.js").FrameState} frameState Frame state.
     */
    applyUniforms(frameState: import("ol/Map").FrameState): void;
    /**
     ...
     * @param {import("../Map.js").FrameState} [frameState] Frame state.
     */
    useProgram(program: WebGLProgram, frameState?: import("ol/Map").FrameState): void;
    /**
     ...
     */
    makeProjectionTransform(frameState: import("ol/Map").FrameState, transform: import("ol/transform").Transform): import("ol/transform").Transform;
    /**
