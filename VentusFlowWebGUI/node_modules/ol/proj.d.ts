 ...
 * @api
 */
export function getPointResolution(projection: ProjectionLike, resolution: number, point: import("ol/coordinate").Coordinate, units?: import("ol/proj/Units").Units): number;
/**
 ...
 */
export function createTransformFromCoordinateTransform(coordTransform: (arg0: import("ol/coordinate").Coordinate) => import("ol/coordinate").Coordinate): TransformFunction;
/**
 ...
 * @api
 */
export function addCoordinateTransforms(source: ProjectionLike, destination: ProjectionLike, forward: (arg0: import("ol/coordinate").Coordinate) => import("ol/coordinate").Coordinate, inverse: (arg0: import("ol/coordinate").Coordinate) => import("ol/coordinate").Coordinate): void;
/**
 ...
 * @api
 */
export function fromLonLat(coordinate: import("ol/coordinate").Coordinate, projection?: ProjectionLike): import("ol/coordinate").Coordinate;
/**
 ...
 * @api
 */
export function toLonLat(coordinate: import("ol/coordinate").Coordinate, projection?: ProjectionLike): import("ol/coordinate").Coordinate;
/**
 ...
 * @api
 */
export function transform(coordinate: import("ol/coordinate").Coordinate, source: ProjectionLike, destination: ProjectionLike): import("ol/coordinate").Coordinate;
/**
 ...
 * @api
 */
export function transformExtent(extent: import("ol/extent").Extent, source: ProjectionLike, destination: ProjectionLike, stops?: number): import("ol/extent").Extent;
/**
 ...
 */
export function transformWithProjections(point: import("ol/coordinate").Coordinate, sourceProjection: Projection, destinationProjection: Projection): import("ol/coordinate").Coordinate;
/**
 ...
 */
export function toUserExtent(extent: import("ol/extent").Extent, sourceProjection: ProjectionLike): import("ol/extent").Extent;
/**
 ...
 */
export function fromUserExtent(extent: import("ol/extent").Extent, destProjection: ProjectionLike): import("ol/extent").Extent;
/**
 ...
 */
export function createSafeCoordinateTransform(sourceProj: Projection, destProj: Projection, transform: (arg0: import("ol/coordinate").Coordinate) => import("ol/coordinate").Coordinate): (arg0: import("ol/coordinate").Coordinate) => import("ol/coordinate").Coordinate;
/**
