...
declare class ImageTile extends Tile {
     ...
     */
    constructor(tileCoord: import("ol/tilecoord").TileCoord, state: any, src: string, crossOrigin: string | null, tileLoadFunction: import("ol/Tile").LoadFunction, options?: import("ol/Tile").Options);
    /**
     * @private
     * @type {?string}
     */
