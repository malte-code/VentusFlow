...
export type Options = {
     ...
     */
    features?: import("ol/Collection").default<Feature<import("ol/geom/Geometry").default>> | undefined;
    /**
     * Destination source for
     * the drawn features.
     */
    source?: VectorSource<Feature<import("ol/geom/Geometry").default>> | undefined;
    /**
     ...
     */
    finishCondition?: import("ol/events/condition").Condition | undefined;
    /**
     ...
     */
    style?: import("ol/style/Style").StyleLike | import("ol/style/flat").FlatStyleLike | undefined;
    /**
     ...
     */
    condition?: import("ol/events/condition").Condition | undefined;
    /**
     ...
     */
    freehandCondition?: import("ol/events/condition").Condition | undefined;
    /**
     * Trace a portion of another geometry.
     * Ignored when in freehand mode.
     */
    trace?: boolean | import("ol/events/condition").Condition | undefined;
    /**
     * Source for features to trace.  If tracing is active and a `traceSource` is
     * not provided, the interaction's `source` will be used.  Tracing requires that the interaction is configured with
     * either a `traceSource` or a `source`.
     */
    traceSource?: VectorSource<Feature<import("ol/geom/Geometry").default>> | undefined;
    /**
     ...
     */
    geometryLayout?: import("ol/geom/Geometry").GeometryLayout | undefined;
};
/**
 * Coordinate type when drawing points.
 */
export type PointCoordType = import("ol/coordinate").Coordinate;
/**
 * Coordinate type when drawing lines.
 */
export type LineCoordType = Array<import("ol/coordinate").Coordinate>;
/**
 * Coordinate type when drawing polygons.
 */
export type PolyCoordType = Array<Array<import("ol/coordinate").Coordinate>>;
/**
...
export type TraceState = {
     ...
     */
    startPx?: import("ol/pixel").Pixel | undefined;
    /**
...
export type TraceTarget = {
     ...
     * Target coordinates.
     */
    coordinates: Array<import("ol/coordinate").Coordinate>;
    /**
 ...
 * a second argument.
 */
export type GeometryFunction = (arg0: SketchCoordType, arg1: import("ol/geom/SimpleGeometry").default, arg2: import("ol/proj/Projection").default) => import("ol/geom/SimpleGeometry").default;
/**
 ...
 * *
 */
export type DrawOnSignature<Return> = import("ol/Observable").OnSignature<import("ol/Observable").EventTypes, import("ol/events/Event").default, Return> & import("ol/Observable").OnSignature<import("ol/ObjectEventType").Types | "change:active", import("ol/Object").ObjectEvent, Return> & import("ol/Observable").OnSignature<"drawabort" | "drawend" | "drawstart", DrawEvent, Return> & import("ol/Observable").CombinedOnSignature<import("ol/Observable").EventTypes | import("ol/ObjectEventType").Types | "change:active" | "drawabort" | "drawend" | "drawstart", Return>;
...
declare class Draw extends PointerInteraction {
     ...
     */
    on: DrawOnSignature<import("ol/events").EventsKey>;
    /***
     * @type {DrawOnSignature<import("../events").EventsKey>}
     */
    once: DrawOnSignature<import("ol/events").EventsKey>;
    /***
     ...
     */
    setTrace(trace: boolean | import("ol/events/condition").Condition): void;
    /**
     ...
     * @override
     */
    override setMap(map: import("ol/Map").default): void;
    /**
     ...
     * @api
     */
    finishDrawing(): Feature<import("ol/geom/SimpleGeometry").default> | null;
    /**
