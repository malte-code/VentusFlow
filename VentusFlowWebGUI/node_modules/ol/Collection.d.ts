 ...
 * *
 */
export type CollectionOnSignature<T, Return> = import("ol/Observable").OnSignature<import("ol/Observable").EventTypes, import("ol/events/Event").default, Return> & import("ol/Observable").OnSignature<import("ol/ObjectEventType").Types | "change:length", import("ol/Object").ObjectEvent, Return> & import("ol/Observable").OnSignature<"add" | "remove", CollectionEvent<T>, Return> & import("ol/Observable").CombinedOnSignature<import("ol/Observable").EventTypes | import("ol/ObjectEventType").Types | "change:length" | "add" | "remove", Return>;
export type Options = {
    /**
