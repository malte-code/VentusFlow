...
declare class Geolocation extends BaseObject {
     ...
     * @api
     */
    getAccuracyGeometry(): import("ol/geom/Polygon").default | null;
    /**
     ...
     * @api
     */
    setProjection(projection: import("ol/proj").ProjectionLike): void;
    /**
