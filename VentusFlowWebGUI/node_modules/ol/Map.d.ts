...
export type FrameState = {
     ...
     */
    viewState: import("ol/View").State;
    /**
     * Animate.
     */
    animate: boolean;
     ...
     */
    coordinateToPixelTransform: import("ol/transform").Transform;
    /**
     * Declutter trees by declutter group.
     * When null, no decluttering is needed because no layers have decluttering enabled.
     */
    declutter: {
        [x: string]: import("rbush").default<import("ol/render/canvas/Executor").DeclutterEntry>;
    } | null;
    /**
     * Extent (in view projection coordinates).
     */
    extent: null | import("ol/extent").Extent;
    /**
     * Next extent during an animation series.
     */
    nextExtent?: import("ol/extent").Extent | undefined;
    /**
     * Index.
     */
    index: number;
     ...
     * LayerStatesArray.
     */
    layerStatesArray: Array<import("ol/layer/Layer").State>;
    /**
     * LayerIndex.
     */
    layerIndex: number;
     ...
     */
    pixelToCoordinateTransform: import("ol/transform").Transform;
    /**
     * PostRenderFunctions.
     */
...
export type AtPixelOptions = {
     ...
     */
    layerFilter?: undefined | ((arg0: import("ol/layer/Layer").default<import("ol/source/Source").default>) => boolean);
    /**
...
export type MapOptionsInternal = {
     ...
     * Controls.
     */
    controls?: Collection<import("ol/control/Control").default> | undefined;
    /**
     * Interactions.
     */
    interactions?: Collection<import("ol/interaction/Interaction").default> | undefined;
    /**
     * KeyboardEventTarget.
     */
     ...
     * Overlays.
     */
    overlays: Collection<import("ol/Overlay").default>;
    /**
     * Values.
     */
    values: {
...
export type MapOptions = {
     ...
     */
    controls?: Collection<import("ol/control/Control").default> | import("ol/control/Control").default[] | undefined;
    /**
     * The ratio between
     ...
     */
    interactions?: Collection<import("ol/interaction/Interaction").default> | import("ol/interaction/Interaction").default[] | undefined;
    /**
     * The element to
     ...
     * layer.
     */
    layers?: import("ol/layer/Base").default[] | Collection<import("ol/layer/Base").default> | LayerGroup | undefined;
    /**
     ...
     */
    overlays?: Collection<import("ol/Overlay").default> | import("ol/Overlay").default[] | undefined;
    /**
     ...
     */
    view?: View | Promise<import("ol/View").ViewOptions> | undefined;
};
/**
 * @classdesc
...
declare class Map extends BaseObject {
     ...
     * @protected
     */
    protected controls: Collection<import("ol/control/Control").default>;
    /**
     * @type {Collection<import("./interaction/Interaction.js").default>}
     * @protected
     */
    protected interactions: Collection<import("ol/interaction/Interaction").default>;
    /**
     ...
     * @api
     */
    addOverlay(overlay: import("ol/Overlay").default): void;
    /**
     ...
     * @api
     */
    forEachFeatureAtPixel<T>(pixel: import("ol/pixel").Pixel, callback: (arg0: import("ol/Feature").FeatureLike, arg1: import("ol/layer/Layer").default<import("ol/source/Source").default>, arg2: import("ol/geom/SimpleGeometry").default) => T, options?: AtPixelOptions): T | undefined;
    /**
     ...
     * @api
     */
    getFeaturesAtPixel(pixel: import("ol/pixel").Pixel, options?: AtPixelOptions): Array<import("ol/Feature").FeatureLike>;
    /**
     ...
     * @api
     */
    hasFeatureAtPixel(pixel: import("ol/pixel").Pixel, options?: AtPixelOptions): boolean;
    /**
     ...
     * @api
     */
    getControls(): Collection<import("ol/control/Control").default>;
    /**
     ...
     * @api
     */
    getOverlays(): Collection<import("ol/Overlay").default>;
    /**
     ...
     * @api
     */
    getOverlayById(id: string | number): import("ol/Overlay").default | null;
    /**
     ...
     * @api
     */
    getInteractions(): Collection<import("ol/interaction/Interaction").default>;
    /**
     ...
     * @api
     */
    setLayers(layers: Array<import("ol/layer/Base").default> | Collection<import("ol/layer/Base").default>): void;
    /**
     * Get the collection of layers associated with this map.
     * @return {!Collection<import("./layer/Base.js").default>} Layers.
     * @api
     */
    getLayers(): Collection<import("ol/layer/Base").default>;
    /**
     ...
     */
    getTilePriority(tile: import("ol/Tile").default, tileSourceKey: string, tileCenter: import("ol/coordinate").Coordinate, tileResolution: number): number;
    /**
     ...
     * @api
     */
    removeOverlay(overlay: import("ol/Overlay").default): import("ol/Overlay").default | undefined;
    /**
