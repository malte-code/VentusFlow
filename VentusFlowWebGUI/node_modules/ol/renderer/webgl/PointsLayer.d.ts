...
export type Point = import("ol/geom/Point").default;
export type PointFeature = import("ol/Feature").default<Point>;
/**
...
export type FeatureCacheItem = {
     ...
     * Point coordinates
     */
    flatCoordinates: import("ol/coordinate").Coordinate;
};
export type Options = {
    /**
     ...
     */
    postProcesses?: import("ol/renderer/webgl/Layer").PostProcessesOptions[] | undefined;
};
...
declare class WebGLPointsLayerRenderer extends WebGLLayerRenderer<any> {
     ...
     */
    constructor(layer: import("ol/layer/Layer").default, options: Options);
    /**
     * @private
     */
     ...
     */
    attributes: Array<import("ol/webgl/Helper").AttributeDescription>;
     ...
     * @override
     */
    override renderFrame(frameState: import("ol/Map").FrameState): HTMLElement;
    /**
     ...
     */
    renderWorlds(frameState: import("ol/Map").FrameState, forHitDetection: boolean, startWorld: number, endWorld: number, worldWidth: number): void;
