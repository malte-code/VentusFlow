...
declare class CanvasVectorLayerRenderer extends CanvasLayerRenderer<any> {
     ...
     */
    constructor(vectorLayer: import("ol/layer/BaseVector").default<any, any, any>);
    /** @private */
     ...
     */
    renderWorlds(executorGroup: ExecutorGroup, frameState: import("ol/Map").FrameState, declutterable?: boolean): void;
    /**
     * @private
     */
     ...
     * @override
     */
    override getFeatures(pixel: import("ol/pixel").Pixel): Promise<Array<import("ol/Feature").default>>;
    /**
     ...
     */
    renderFeature(feature: import("ol/Feature").default, squaredTolerance: number, styles: import("ol/style/Style").default | Array<import("ol/style/Style").default>, builderGroup: import("ol/render/canvas/BuilderGroup").default, transform?: import("ol/proj").TransformFunction, declutter?: boolean, index?: number): boolean;
}
