 ...
 */
export function drawImageOrLabel(context: CanvasRenderingContext2D | import("ol/render/canvas/ZIndexContext").ZIndexContextProxy, transform: import("ol/transform").Transform | null, opacity: number, labelOrImage: Label | HTMLCanvasElement | HTMLImageElement | HTMLVideoElement, originX: number, originY: number, w: number, h: number, x: number, y: number, scale: import("ol/size").Size): void;
/**
 ...
 */
export const defaultStrokeStyle: import("ol/colorlike").ColorLike;
/**
 * @const
...
export type FillState = {
     ...
     * FillStyle.
     */
    fillStyle: import("ol/colorlike").ColorLike;
};
export type Label = {
    /**
     * Width.
...
export type FillStrokeState = {
     ...
     * Current FillStyle.
     */
    currentFillStyle?: import("ol/colorlike").ColorLike | undefined;
    /**
     * Current StrokeStyle.
     */
    currentStrokeStyle?: import("ol/colorlike").ColorLike | undefined;
    /**
     * Current LineCap.
     */
     ...
     * FillStyle.
     */
    fillStyle?: import("ol/colorlike").ColorLike | undefined;
    /**
     * StrokeStyle.
     */
    strokeStyle?: import("ol/colorlike").ColorLike | undefined;
    /**
     * LineCap.
     */
...
export type StrokeState = {
     ...
     * StrokeStyle.
     */
    strokeStyle: import("ol/colorlike").ColorLike;
};
export type TextState = {
     ...
     * Justify.
     */
    justify?: import("ol/style/Text").TextJustify | undefined;
    /**
     * TextBaseline.
     */
     ...
     * Placement.
     */
    placement?: import("ol/style/Text").TextPlacement | undefined;
    /**
     * MaxAngle.
     */
     ...
     * BackgroundFill.
     */
    backgroundFill?: import("ol/style/Fill").default | undefined;
    /**
     * BackgroundStroke.
     */
    backgroundStroke?: import("ol/style/Stroke").default | undefined;
    /**
     * Scale.
     */
    scale?: import("ol/size").Size | undefined;
    /**
     * Padding.
     */
...
export type DeclutterImageWithText = {
    [x: number]: import("ol/render/canvas/Executor").ReplayImageOrLabelArgs;
};
