...
declare class RenderFeature {
     ...
     */
    styleFunction: import("ol/style/Style").StyleFunction | undefined;
    /**
     * @private
     ...
     * @return {RenderFeature} Simplified geometry.
     */
    simplifyTransformed(squaredTolerance: number, transform?: import("ol/proj").TransformFunction): RenderFeature;
    /**
     ...
     */
    transform(projection: import("ol/proj").ProjectionLike): void;
    /**
