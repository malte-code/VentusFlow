 ...
 */
export function closestOnCircle(coordinate: Coordinate, circle: import("ol/geom/Circle").default): Coordinate;
/**
 ...
 */
export function wrapX(coordinate: Coordinate, projection: import("ol/proj/Projection").default): Coordinate;
/**
 * @param {Coordinate} coordinate Coordinate.
 * @param {import("./proj/Projection.js").default} projection Projection.
 ...
 */
export function getWorldsAway(coordinate: Coordinate, projection: import("ol/proj/Projection").default, sourceExtentWidth?: number): number;
/**
 * An array of numbers representing an `xy`, `xyz` or `xyzm` coordinate.
 * Example: `[16, 48]`.
 */
