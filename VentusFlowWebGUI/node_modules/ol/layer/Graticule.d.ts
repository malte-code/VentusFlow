 ...
 * @api
 */
declare class Graticule extends VectorLayer<VectorSource<Feature<import("ol/geom").Geometry>>, Feature<import("ol/geom").Geometry>> {
    /**
     ...
     */
    strategyFunction(extent: import("ol/extent").Extent, resolution: number): Array<import("ol/extent").Extent>;
    /**
     ...
     */
    loaderFunction(extent: import("ol/extent").Extent, resolution: number, projection: import("ol/proj/Projection").default): void;
    /**
