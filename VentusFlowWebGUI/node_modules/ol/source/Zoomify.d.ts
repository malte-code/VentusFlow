...
export class CustomTile extends ImageTile {
     ...
     */
    constructor(tileSize: import("ol/size").Size, tileCoord: import("ol/tilecoord").TileCoord, state: any, src: string, crossOrigin: string | null, tileLoadFunction: import("ol/Tile").LoadFunction, options?: import("ol/Tile").Options);
    /**
     * @private
