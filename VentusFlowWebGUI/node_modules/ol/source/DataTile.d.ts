 ...
 */
export type Loader = (arg0: number, arg1: number, arg2: number, arg3: LoaderOptions) => (import("ol/DataTile").Data | Promise<import("ol/DataTile").Data>);
export type Options = {
    /**
 ...
 * @api
 */
declare class DataTileSource<TileType extends import("ol/Tile").default = DataTile> extends TileSource<TileType> {
    /**
     ...
     */
    handleTileChange_(event: import("ol/events/Event").default): void;
    /**
     * @type {number}
     */
    bandCount: number;
     ...
     */
    transformMatrix: import("ol/transform").Transform | null;
    /**
     ...
     */
    protected setTileSizes(tileSizes: Array<import("ol/size").Size>): void;
    /**
     ...
     */
    protected getTileSize(z: number): import("ol/size").Size;
    /**
     ...
     */
    getReprojTile_(z: number, x: number, y: number, targetProj: import("ol/proj/Projection").default, sourceProj: import("ol/proj/Projection").default): TileType;
    /**
     * @param {number} z Tile coordinate z.
     * @param {number} x Tile coordinate x.
     * @param {number} y Tile coordinate y.
     ...
     * @override
     */
    override getTile(z: number, x: number, y: number, pixelRatio: number, projection?: import("ol/proj/Projection").default): TileType | null;
    /**
     ...
     * @api
     */
    setTileGridForProjection(projection: import("ol/proj").ProjectionLike, tilegrid: import("ol/tilegrid/TileGrid").default): void;
}
