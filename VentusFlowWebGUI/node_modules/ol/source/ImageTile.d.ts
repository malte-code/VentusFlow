 ...
 */
export type Loader = (arg0: number, arg1: number, arg2: number, arg3: import("ol/source/DataTile").LoaderOptions) => (import("ol/DataTile").ImageLike | Promise<import("ol/DataTile").ImageLike>);
export type UrlGetter = (arg0: number, arg1: number, arg2: number, arg3: import("ol/source/DataTile").LoaderOptions) => string;
...
export type Options = {
     ...
     * Tile grid.
     */
    tileGrid?: import("ol/tilegrid/TileGrid").default | undefined;
    /**
     * The source state.
     */
     ...
     */
    crossOrigin?: import("ol/source/DataTile").CrossOriginAttribute | undefined;
    /**
 ...
 * @api
 */
declare class ImageTileSource extends DataTileSource<import("ol/ImageTile").default> {
    /**
