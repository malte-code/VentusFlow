 ...
 */
export function getRequestUrl(baseUrl: string, extent: import("ol/extent").Extent, resolution: number, pixelRatio: number, projection: import("ol/proj/Projection").default, params: any): string;
/**
