 ...
 */
export type Attribution = (arg0: import("ol/View").ViewStateLayerStateExtent) => (string | Array<string>);
/**
...
declare class Source extends BaseObject {
     ...
     */
    protected projection: import("ol/proj/Projection").default | null;
    /**
     * @private
     * @type {?Attribution}
     */
     ...
     */
    protected viewResolver: (arg0: import("ol/View").ViewOptions) => void;
    /**
     * @protected
     ...
     */
    getResolutions(projection?: import("ol/proj/Projection").default): Array<number> | null;
    /**
