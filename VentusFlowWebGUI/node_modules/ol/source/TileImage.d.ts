...
declare class TileImage extends UrlTile {
    ...
    protected tileGridForProjection: {
        [x: string]: import("ol/tilegrid/TileGrid").default;
    };
    /**
     * @private
     ...
     * @override
     */
    override getTile(z: number, x: number, y: number, pixelRatio: number, projection: import("ol/proj/Projection").default): (ImageTile | ReprojTile);
    /**
     * @param {number} z Tile coordinate z.
     * @param {number} x Tile coordinate x.
     * @param {number} y Tile coordinate y.
     ...
     * @protected
     */
    protected getTileInternal(z: number, x: number, y: number, pixelRatio: number, projection: import("ol/proj/Projection").default): ImageTile;
    /**
