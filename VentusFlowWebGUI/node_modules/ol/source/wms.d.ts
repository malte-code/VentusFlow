 ...
 */
export function getRequestUrl(baseUrl: string, extent: import("ol/extent").Extent, size: import("ol/size").Size, projection: import("ol/proj/Projection").default, params: any): string;
/**
 ...
 */
export function getImageSrc(extent: import("ol/extent").Extent, resolution: number, pixelRatio: number, projection: import("ol/proj").Projection, url: string, params: any, serverType: import("ol/source/wms").ServerType): string;
/**
 * @param {Object} params WMS params.
 ...
 * @api
 */
export function createLoader(options: LoaderOptions): import("ol/Image").ImageObjectPromiseLoader;
/**
 ...
 * @api
 */
export function getFeatureInfoUrl(options: LoaderOptions, coordinate: import("ol/coordinate").Coordinate, resolution: number): string | undefined;
/**
...
export type LoaderOptions = {
     ...
     * returns a promise resolving to the loaded or decoded image. Default is {@link module :ol/Image.decode}.
     */
    load?: ((arg0: HTMLImageElement, arg1: string) => Promise<import("ol/DataTile").ImageLike>) | undefined;
};
