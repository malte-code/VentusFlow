 ...
 */
export function defaultLoadFunction<FeatureType extends import("ol/Feature").FeatureLike = import("ol/render/Feature").default>(tile: import("ol/VectorTile").default<FeatureType>, url: string): void;
export default VectorTile;
export type Options<FeatureType extends import("ol/Feature").FeatureLike = import("ol/render/Feature").default> = {
    /**
     * Attributions.
     */
 ...
 * @template {import("../Feature.js").FeatureLike} [FeatureType=import("../render/Feature.js").default]
 */
declare class VectorTile<FeatureType extends import("ol/Feature").FeatureLike = import("ol/render/Feature").default> extends UrlTile {
    /**
     ...
     */
    getSourceTiles(pixelRatio: number, projection: import("ol/proj/Projection").default, tile: VectorRenderTile): Array<Tile<any>>;
    /**
     * @param {VectorRenderTile} tile Vector render tile.
     */
     ...
     * @override
     */
    override getTile(z: number, x: number, y: number, pixelRatio: number, projection: import("ol/proj/Projection").default): VectorRenderTile;
    /**
