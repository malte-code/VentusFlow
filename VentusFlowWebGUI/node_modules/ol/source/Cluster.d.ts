...
export type GeometryFunction<FeatureType extends import("ol/Feature").FeatureLike = import("ol/Feature").FeatureLike> = (feature: FeatureType) => (Point | null);
export type Options<FeatureType extends import("ol/Feature").FeatureLike = Feature<import("ol/geom/Geometry").default>> = {
    /**
     * Attributions.
     */
 ...
 */
declare class Cluster<FeatureType extends import("ol/Feature").FeatureLike = Feature<import("ol/geom/Geometry").default>> extends VectorSource<Feature<import("ol/geom/Geometry").default>> {
    /**
     ...
     * @protected
     */
    protected geometryFunction: GeometryFunction<import("ol/Feature").FeatureLike>;
    /**
     ...
     * @protected
     */
    protected createCluster(features: Array<FeatureType>, extent: import("ol/extent").Extent): Feature;
}
