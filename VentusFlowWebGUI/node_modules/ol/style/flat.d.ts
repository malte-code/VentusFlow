 ...
 * (e.g. `[0, 255, 0, 0.5]`), or an expression that evaluates to one of these color types (e.g. `['get', 'color']`).
 */
export type ColorExpression = import("ol/color").Color | string | any[];
/**
 * An array of numbers (e.g. `[1, 2, 3]`) or an expression that evaluates to the same (e.g. `['get', 'values']`).
 */
...
export type FlatFill = {
     ...
     * `top-left` or `top-right`. (WebGL only)
     */
    "fill-pattern-offset-origin"?: import("ol/style/Icon").IconOrigin | undefined;
};
/**
 * Stroke style properties applied to line strings and polygon boundaries. To apply a stroke, at least one of
 * `stroke-color` or `stroke-width` must be provided.
...
export type FlatStroke = {
     ...
     * `top-left` or `top-right`. (WebGL only)
     */
    "stroke-pattern-offset-origin"?: import("ol/style/Icon").IconOrigin | undefined;
    /**
...
export type FlatText = {
     ...
     * Declutter mode
     */
    "text-declutter-mode"?: import("ol/style/Style").DeclutterMode | undefined;
    /**
     * The zIndex of the style.
     */
    "z-index"?: NumberExpression | undefined;
...
export type FlatIcon = {
     ...
     * `top-left` or `top-right`.
     */
    "icon-anchor-origin"?: import("ol/style/Icon").IconOrigin | undefined;
    /**
     * Units in which the anchor x value is
     * specified. A value of `'fraction'` indicates the x value is a fraction of the icon. A value of `'pixels'` indicates
     * the x value in pixels.
     */
    "icon-anchor-x-units"?: import("ol/style/Icon").IconAnchorUnits | undefined;
    /**
     * Units in which the anchor y value is
     * specified. A value of `'fraction'` indicates the y value is a fraction of the icon. A value of `'pixels'` indicates
     * the y value in pixels.
     */
    "icon-anchor-y-units"?: import("ol/style/Icon").IconAnchorUnits | undefined;
    /**
     ...
     * `top-left` or `top-right`.
     */
    "icon-offset-origin"?: import("ol/style/Icon").IconOrigin | undefined;
    /**
     * Opacity of the icon.
     */
     ...
     */
    "icon-declutter-mode"?: import("ol/style/Style").DeclutterMode | undefined;
    /**
...
export type FlatShape = {
     ...
     * Declutter mode. (Canvas only)
     */
    "shape-declutter-mode"?: import("ol/style/Style").DeclutterMode | undefined;
    /**
     * The zIndex of the style. (Canvas only)
     */
    "z-index"?: NumberExpression | undefined;
...
export type FlatCircle = {
     ...
     * Declutter mode (Canvas only)
     */
    "circle-declutter-mode"?: import("ol/style/Style").DeclutterMode | undefined;
    /**
     * The zIndex of the style. (Canvas only)
     */
    "z-index"?: NumberExpression | undefined;
