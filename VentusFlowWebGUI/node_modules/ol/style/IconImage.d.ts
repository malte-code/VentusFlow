 ...
 */
export function get(image: HTMLImageElement | HTMLCanvasElement | ImageBitmap | null, cacheKey: string | undefined, crossOrigin: string | null, imageState: any | undefined, color: import("ol/color").Color | string | null, pattern?: boolean): IconImage;
...
declare class IconImage extends EventTarget {
     ...
     * @param {import("../color.js").Color|string|null} color Color.
     */
    constructor(image: HTMLImageElement | HTMLCanvasElement | ImageBitmap | null, src: string | undefined, crossOrigin: string | null, imageState: any | undefined, color: import("ol/color").Color | string | null);
    /**
     * @private
