 ...
 * @api
 */
export function asColorLike(color: import("ol/color").Color | ColorLike | PatternDescriptor | null): ColorLike | null;
export type PatternDescriptor = {
     ...
     */
    color?: string | import("ol/color").Color | undefined;
    /**
     ...
     * Use this together with `size` when the pattern image is a sprite sheet.
     */
    offset?: import("ol/size").Size | undefined;
};
/**
 * A type accepted by CanvasRenderingContext2D.fillStyle
 * or CanvasRenderingContext2D.strokeStyle.
