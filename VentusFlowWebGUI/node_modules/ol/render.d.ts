 ...
 * @api
 */
export function getVectorContext(event: import("ol/render/Event").default): CanvasImmediateRenderer;
/**
 ...
 * @api
 */
export function getRenderPixel(event: import("ol/render/Event").default, pixel: import("ol/pixel").Pixel): import("ol/pixel").Pixel;
export type State = {
    /**
     ...
     * Geometry.
     */
    geometry: import("ol/geom/SimpleGeometry").default;
    /**
 ...
 * {@link module :ol/render/Feature~RenderFeature} and returns a `{number}`.
 */
export type OrderFunction = (arg0: import("ol/Feature").FeatureLike, arg1: import("ol/Feature").FeatureLike) => number;
